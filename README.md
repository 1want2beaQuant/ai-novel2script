...
- 提供本地 Web 工作台，可在浏览器中导入手稿、预检章节识别和每章素材规模、转换并切换查看
  YAML/Fountain/Markdown 修订简报/draft JSON/summary JSON、查看 coverage 诊断、结构节拍、场景索引、场景块预览和修订动作，
