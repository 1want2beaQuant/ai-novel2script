...
- 提供本地 Web 工作台，可在浏览器中导入手稿、预检章节识别、转换并切换查看
  YAML/Fountain/draft JSON/summary JSON、查看 coverage 诊断、结构节拍、场景索引和修订动作，
